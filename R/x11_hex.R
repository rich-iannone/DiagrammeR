...
#' @description Create a data frame containing
#' information on X11 colors and their corresponding
...
x11_hex <- function() {
  ...
  x11_name <- c(
    ...
    'goldenrod3', 'goldenrod4', 'gray', 'gray0',
    ...
    'grey97', 'grey98', 'grey99', 'honeydew',
    'honeydew1', 'honeydew2', 'honeydew3', 'honeydew4',
    'hotpink', 'hotpink1', 'hotpink2', 'hotpink3',
    'hotpink4', 'indianred', 'indianred1', 'indianred2',
    'indianred3', 'indianred4', 'indigo', 'invis',
    ...
    'lightgray', 'lightgrey', 'lightpink', 'lightpink1',
    ...
    'navajowhite4', 'navy', 'navyblue', 'none', 'oldlace',
    ...
    'skyblue3', 'skyblue4', 'slateblue', 'slateblue1',
    ...
    'transparent', 'turquoise', 'turquoise1',
  ...
  hex <- c(
    '#f0f8ff', '#faebd7', '#ffefdb', '#eedfcc', '#cdc0b0',
    '#8b8378', '#7fffd4', '#7fffd4', '#76eec6', '#66cdaa',
    '#458b74', '#f0ffff', '#f0ffff', '#e0eeee', '#c1cdcd',
    '#838b8b', '#f5f5dc', '#ffe4c4', '#ffe4c4', '#eed5b7',
    '#cdb79e', '#8b7d6b', '#000000', '#ffebcd', '#0000ff',
    '#0000ff', '#0000ee', '#0000cd', '#00008b', '#8a2be2',
    '#a52a2a', '#ff4040', '#ee3b3b', '#cd3333', '#8b2323',
    '#deb887', '#ffd39b', '#eec591', '#cdaa7d', '#8b7355',
    '#5f9ea0', '#98f5ff', '#8ee5ee', '#7ac5cd', '#53868b',
    '#7fff00', '#7fff00', '#76ee00', '#66cd00', '#458b00',
    '#d2691e', '#ff7f24', '#ee7621', '#cd661d', '#8b4513',
    '#ff7f50', '#ff7256', '#ee6a50', '#cd5b45', '#8b3e2f',
    '#6495ed', '#fff8dc', '#fff8dc', '#eee8cd', '#cdc8b1',
    '#8b8878', '#dc143c', '#00ffff', '#00ffff', '#00eeee',
    '#00cdcd', '#008b8b', '#b8860b', '#ffb90f', '#eead0e',
    '#cd950c', '#8b6508', '#006400', '#bdb76b', '#556b2f',
    '#caff70', '#bcee68', '#a2cd5a', '#6e8b3d', '#ff8c00',
    '#ff7f00', '#ee7600', '#cd6600', '#8b4500', '#9932cc',
    '#bf3eff', '#b23aee', '#9a32cd', '#68228b', '#e9967a',
    '#8fbc8f', '#c1ffc1', '#b4eeb4', '#9bcd9b', '#698b69',
    '#483d8b', '#2f4f4f', '#97ffff', '#8deeee', '#79cdcd',
    '#528b8b', '#2f4f4f', '#00ced1', '#9400d3', '#ff1493',
    '#ff1493', '#ee1289', '#cd1076', '#8b0a50', '#00bfff',
    '#00bfff', '#00b2ee', '#009acd', '#00688b', '#696969',
    '#696969', '#1e90ff', '#1e90ff', '#1c86ee', '#1874cd',
    '#104e8b', '#b22222', '#ff3030', '#ee2c2c', '#cd2626',
    '#8b1a1a', '#fffaf0', '#228b22', '#dcdcdc', '#f8f8ff',
    '#ffd700', '#ffd700', '#eec900', '#cdad00', '#8b7500',
    '#daa520', '#ffc125', '#eeb422', '#cd9b1d', '#8b6914',
    '#c0c0c0', '#000000', '#030303', '#1a1a1a', '#ffffff',
    '#1c1c1c', '#1f1f1f', '#212121', '#242424', '#262626',
    '#292929', '#2b2b2b', '#2e2e2e', '#303030', '#050505',
    '#333333', '#363636', '#383838', '#3b3b3b', '#3d3d3d',
    '#404040', '#424242', '#454545', '#474747', '#4a4a4a',
    '#080808', '#4d4d4d', '#4f4f4f', '#525252', '#545454',
    '#575757', '#595959', '#5c5c5c', '#5e5e5e', '#616161',
    '#636363', '#0a0a0a', '#666666', '#696969', '#6b6b6b',
    '#6e6e6e', '#707070', '#737373', '#757575', '#787878',
    '#7a7a7a', '#7d7d7d', '#0d0d0d', '#7f7f7f', '#828282',
    '#858585', '#878787', '#8a8a8a', '#8c8c8c', '#8f8f8f',
    '#919191', '#949494', '#969696', '#0f0f0f', '#999999',
    '#9c9c9c', '#9e9e9e', '#a1a1a1', '#a3a3a3', '#a6a6a6',
    '#a8a8a8', '#ababab', '#adadad', '#b0b0b0', '#121212',
    '#b3b3b3', '#b5b5b5', '#b8b8b8', '#bababa', '#bdbdbd',
    '#bfbfbf', '#c2c2c2', '#c4c4c4', '#c7c7c7', '#c9c9c9',
    '#141414', '#cccccc', '#cfcfcf', '#d1d1d1', '#d4d4d4',
    '#d6d6d6', '#d9d9d9', '#dbdbdb', '#dedede', '#e0e0e0',
    '#e3e3e3', '#171717', '#e5e5e5', '#e8e8e8', '#ebebeb',
    '#ededed', '#f0f0f0', '#f2f2f2', '#f5f5f5', '#f7f7f7',
    '#fafafa', '#fcfcfc', '#00ff00', '#00ff00', '#00ee00',
    '#00cd00', '#008b00', '#adff2f', '#c0c0c0', '#000000',
    '#030303', '#1a1a1a', '#ffffff', '#1c1c1c', '#1f1f1f',
    '#212121', '#242424', '#262626', '#292929', '#2b2b2b',
    '#2e2e2e', '#303030', '#050505', '#333333', '#363636',
    '#383838', '#3b3b3b', '#3d3d3d', '#404040', '#424242',
    '#454545', '#474747', '#4a4a4a', '#080808', '#4d4d4d',
    '#4f4f4f', '#525252', '#545454', '#575757', '#595959',
    '#5c5c5c', '#5e5e5e', '#616161', '#636363', '#0a0a0a',
    '#666666', '#696969', '#6b6b6b', '#6e6e6e', '#707070',
    '#737373', '#757575', '#787878', '#7a7a7a', '#7d7d7d',
    '#0d0d0d', '#7f7f7f', '#828282', '#858585', '#878787',
    '#8a8a8a', '#8c8c8c', '#8f8f8f', '#919191', '#949494',
    '#969696', '#0f0f0f', '#999999', '#9c9c9c', '#9e9e9e',
    '#a1a1a1', '#a3a3a3', '#a6a6a6', '#a8a8a8', '#ababab',
    '#adadad', '#b0b0b0', '#121212', '#b3b3b3', '#b5b5b5',
    '#b8b8b8', '#bababa', '#bdbdbd', '#bfbfbf', '#c2c2c2',
    '#c4c4c4', '#c7c7c7', '#c9c9c9', '#141414', '#cccccc',
    '#cfcfcf', '#d1d1d1', '#d4d4d4', '#d6d6d6', '#d9d9d9',
    '#dbdbdb', '#dedede', '#e0e0e0', '#e3e3e3', '#171717',
    '#e5e5e5', '#e8e8e8', '#ebebeb', '#ededed', '#f0f0f0',
    '#f2f2f2', '#f5f5f5', '#f7f7f7', '#fafafa', '#fcfcfc',
    '#f0fff0', '#f0fff0', '#e0eee0', '#c1cdc1', '#838b83',
    '#ff69b4', '#ff6eb4', '#ee6aa7', '#cd6090', '#8b3a62',
    '#cd5c5c', '#ff6a6a', '#ee6363', '#cd5555', '#8b3a3a',
    '#4b0082', '#fffffe', '#fffff0', '#fffff0', '#eeeee0',
    '#cdcdc1', '#8b8b83', '#f0e68c', '#fff68f', '#eee685',
    '#cdc673', '#8b864e', '#e6e6fa', '#fff0f5', '#fff0f5',
    '#eee0e5', '#cdc1c5', '#8b8386', '#7cfc00', '#fffacd',
    '#fffacd', '#eee9bf', '#cdc9a5', '#8b8970', '#add8e6',
    '#bfefff', '#b2dfee', '#9ac0cd', '#68838b', '#f08080',
    '#e0ffff', '#e0ffff', '#d1eeee', '#b4cdcd', '#7a8b8b',
    '#eedd82', '#ffec8b', '#eedc82', '#cdbe70', '#8b814c',
    '#fafad2', '#d3d3d3', '#d3d3d3', '#ffb6c1', '#ffaeb9',
    '#eea2ad', '#cd8c95', '#8b5f65', '#ffa07a', '#ffa07a',
    '#ee9572', '#cd8162', '#8b5742', '#20b2aa', '#87cefa',
    '#b0e2ff', '#a4d3ee', '#8db6cd', '#607b8b', '#8470ff',
    '#778899', '#778899', '#b0c4de', '#cae1ff', '#bcd2ee',
    '#a2b5cd', '#6e7b8b', '#ffffe0', '#ffffe0', '#eeeed1',
    '#cdcdb4', '#8b8b7a', '#32cd32', '#faf0e6', '#ff00ff',
    '#ff00ff', '#ee00ee', '#cd00cd', '#8b008b', '#b03060',
    '#ff34b3', '#ee30a7', '#cd2990', '#8b1c62', '#66cdaa',
    '#0000cd', '#ba55d3', '#e066ff', '#d15fee', '#b452cd',
    '#7a378b', '#9370db', '#ab82ff', '#9f79ee', '#8968cd',
    '#5d478b', '#3cb371', '#7b68ee', '#00fa9a', '#48d1cc',
    '#c71585', '#191970', '#f5fffa', '#ffe4e1', '#ffe4e1',
    '#eed5d2', '#cdb7b5', '#8b7d7b', '#ffe4b5', '#ffdead',
    '#ffdead', '#eecfa1', '#cdb38b', '#8b795e', '#000080',
    '#000080', '#fffffe', '#fdf5e6', '#6b8e23', '#c0ff3e',
    '#b3ee3a', '#9acd32', '#698b22', '#ffa500', '#ffa500',
    '#ee9a00', '#cd8500', '#8b5a00', '#ff4500', '#ff4500',
    '#ee4000', '#cd3700', '#8b2500', '#da70d6', '#ff83fa',
    '#ee7ae9', '#cd69c9', '#8b4789', '#eee8aa', '#98fb98',
    '#9aff9a', '#90ee90', '#7ccd7c', '#548b54', '#afeeee',
    '#bbffff', '#aeeeee', '#96cdcd', '#668b8b', '#db7093',
    '#ff82ab', '#ee799f', '#cd6889', '#8b475d', '#ffefd5',
    '#ffdab9', '#ffdab9', '#eecbad', '#cdaf95', '#8b7765',
    '#cd853f', '#ffc0cb', '#ffb5c5', '#eea9b8', '#cd919e',
    '#8b636c', '#dda0dd', '#ffbbff', '#eeaeee', '#cd96cd',
    '#8b668b', '#b0e0e6', '#a020f0', '#9b30ff', '#912cee',
    '#7d26cd', '#551a8b', '#ff0000', '#ff0000', '#ee0000',
    '#cd0000', '#8b0000', '#bc8f8f', '#ffc1c1', '#eeb4b4',
    '#cd9b9b', '#8b6969', '#4169e1', '#4876ff', '#436eee',
    '#3a5fcd', '#27408b', '#8b4513', '#fa8072', '#ff8c69',
    '#ee8262', '#cd7054', '#8b4c39', '#f4a460', '#2e8b57',
    '#54ff9f', '#4eee94', '#43cd80', '#2e8b57', '#fff5ee',
    '#fff5ee', '#eee5de', '#cdc5bf', '#8b8682', '#a0522d',
    '#ff8247', '#ee7942', '#cd6839', '#8b4726', '#87ceeb',
    '#87ceff', '#7ec0ee', '#6ca6cd', '#4a708b', '#6a5acd',
    '#836fff', '#7a67ee', '#6959cd', '#473c8b', '#708090',
    '#c6e2ff', '#b9d3ee', '#9fb6cd', '#6c7b8b', '#708090',
    '#fffafa', '#fffafa', '#eee9e9', '#cdc9c9', '#8b8989',
    '#00ff7f', '#00ff7f', '#00ee76', '#00cd66', '#008b45',
    '#4682b4', '#63b8ff', '#5cacee', '#4f94cd', '#36648b',
    '#d2b48c', '#ffa54f', '#ee9a49', '#cd853f', '#8b5a2b',
    '#d8bfd8', '#ffe1ff', '#eed2ee', '#cdb5cd', '#8b7b8b',
    '#ff6347', '#ff6347', '#ee5c42', '#cd4f39', '#8b3626',
    '#fffffe', '#40e0d0', '#00f5ff', '#00e5ee', '#00c5cd',
    '#00868b', '#ee82ee', '#d02090', '#ff3e96', '#ee3a8c',
    '#cd3278', '#8b2252', '#f5deb3', '#ffe7ba', '#eed8ae',
    '#cdba96', '#8b7e66', '#ffffff', '#f5f5f5', '#ffff00',
    '#ffff00', '#eeee00', '#cdcd00', '#8b8b00', '#9acd32')

  x11_hex_values <-
    data.frame(x11_name, hex,

...
#' or 3-number ISO 4217 currency code. If a
#' single-length value is provided, then that format
#' type will be applied to both the x and y axes.
#' Providing a vector of length 2 will apply the

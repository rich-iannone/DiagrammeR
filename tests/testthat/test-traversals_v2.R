...
test_that("simple traversals are possible", {
  ...
  expect_error(graph %>% trav_in_v2)
  expect_error(graph %>% trav_out_v2)
  expect_error(graph %>% trav_both_v2)
  expect_error(graph %>% trav_in_node_v2)
  expect_error(graph %>% trav_out_node_v2)
  expect_error(graph %>% trav_in_edge_v2)
  expect_error(graph %>% trav_out_edge_v2)
})
...
test_that("selective traversals with `trav_out_edge()` are possible", {
  ...
  graph <-
    ...
    clear_selection %>%
    select_nodes_by_id(1) %>%
    trav_out_edge_v2("data_value < 10")
  ...
  graph <-
    ...
    clear_selection %>%
    select_nodes_by_id(1) %>%
    trav_out_edge_v2("rel == 'related_to'")
  ...
  graph <-
    ...
    clear_selection %>%
    select_nodes_by_id(1) %>%
    trav_out_edge_v2("rel == 'belongs_with'")
...
test_that("selective traversals with `trav_in_edge()` are possible", {
  ...
  graph <-
    ...
    clear_selection %>%
    select_nodes_by_id(4) %>%
    trav_in_edge_v2("rel == 'related_to'")
  ...
  graph <-
    ...
    clear_selection %>%
    select_nodes_by_id(4) %>%
    trav_in_edge_v2("rel == 'belongs_with'")
...
test_that("selective traversals with `trav_in_node()` are possible", {
  ...
  graph <-
    ...
    clear_selection %>%
    select_edges(from = 3, to = 4) %>%
    trav_in_node_v2("shape == 'triangle'")
...
test_that("selective traversals with `trav_out_node()` are possible", {
  ...
  graph <-
    ...
    clear_selection %>%
    select_edges(from = 1, to = 2) %>%
    trav_out_node_v2("data_value < 10")
  ...
  graph <-
    ...
    clear_selection %>%
    select_edges(from = 1, to = 2) %>%
    trav_out_node_v2("shape == 'triangle'")

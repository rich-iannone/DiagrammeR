...
test_that("Using an invalid graph with trigger an error", {
  ...
  expect_error(add_graph_to_graph_series(invalid_graph))
  ...
  expect_error(transform_to_complement_graph(invalid_graph))
  expect_error(transform_to_min_spanning_tree(invalid_graph))
  expect_error(transform_to_subgraph_ws(invalid_graph))

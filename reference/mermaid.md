...
[mermaid.js](https://github.com/mermaid-js/mermaid/wiki) with
infrastructure provided by [htmlwidgets](http://www.htmlwidgets.org/).
...
- diagram:
  ...
  file name) containing a diagram specification. If no diagram is

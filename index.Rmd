...
![Example7a](images/Example_7a.png)
...
![Example7b](images/Example_7b.png)
...
![Example_7c_neato](images/Example_7c_neato.png)

```R
grViz(boxes_and_circles, engine = "twopi")
```

![Example_7d_twopi](images/Example_7d_twopi.png)

```R
grViz(boxes_and_circles, engine = "circo")
```

![Example_7e_circo](images/Example_7e_circo.png)
